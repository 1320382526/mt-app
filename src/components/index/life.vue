    ...
    <div class="m-life">
        <el-row>
            <ul class="nav">
                ...
                <li>
                    <router-link to="/" class="takeout">猫眼电影</router-link>
                </li>
                <li>
                    <router-link to="/" class="takeout">美团酒店</router-link>
                </li>
                <li>
                    <router-link to="/" class="takeout">民宿公寓</router-link>
                </li>
                <li>
                    <router-link to="/" class="takeout">商家入驻</router-link>
                </li>
                <li>
                    <router-link to="/" class="takeout">美团公益</router-link>
                </li>
            </ul>
        </el-row>
        <el-row>
            ...
            <el-col :span="6">
                <div class="m-life-login">
                    ...
                    <p v-if="!$store.state.userName">
                        <router-link :to="{name: 'register'}"><el-button round>注册</el-button></router-link>
                    </p>
                    <p v-if="!$store.state.userName">
                        <router-link :to="{name: 'login'}"><el-button round>立即登录</el-button></router-link>
                    </p>
                </div>
            </el-col>
        </el-row>
